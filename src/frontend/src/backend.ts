...
export class Backend implements backendInterface {
    ...
    async findStoriesByXHandle(arg0: string): Promise<Array<StoryData>> {
        if (this.processError) {
            try {
                const result = await this.actor.findStoriesByXHandle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllStories(): Promise<Array<StoryData>> {
        if (this.processError) {
            try {
    ...
    async submitStory(arg0: StorySubmission): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitStory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
